...
class Agent:
    ...
    def from_corpus(
        ...
        Args:
            ...
            genesis_filter_fields (List[dict], optional): The filterable attributes (each dict maps field name to Tuple[type, description]).
    ...
    def chat(self, prompt: str) -> str:
        ...
        try:
            ...
            import traceback
            return f"Genesis Agentic: encountered an exception ({e}) at ({traceback.format_exc()}), and can't respond."
