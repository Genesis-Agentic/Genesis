...
from .tools import GenesisToolFactory, GenesisTool, ToolsFactory
...
class Agent:
    ...
    def from_corpus(
        ...
        query_logging_callback: Optional[Callable[[str, str], None]] = None,
        verbose: bool = False,
        genesis_filter_fields: list[dict] = [],
        ...
        Args:
            ...
            genesis_filter_fields (List[dict], optional): The filterable attributes
                (each dict maps field name to Tuple[type, description]).
            genesis_lambda_val (float, optional): The lambda value for Genesis hybrid search.
            genesis_reranker (str, optional): The Genesis reranker name (default "mmr")
            genesis_rerank_k (int, optional): The number of results to use with reranking.
            genesis_n_sentences_before (int, optional): The number of sentences before the matching text
            genesis_n_sentences_after (int, optional): The number of sentences after the matching text.
            genesis_summary_num_results (int, optional): The number of results to use in summarization.
            genesis_summarizer (str, optional): The Genesis summarizer name.
        ...
        for field in genesis_filter_fields:
        ...
        genesis_tool = vec_factory.create_rag_tool(
            ...
            reranker=genesis_reranker,
            rerank_k=genesis_rerank_k,
    ...
    async def achat(self, prompt: str) -> AgentResponse:    # type: ignore
        ...
        try:
            ...
            return AgentResponse(
                response = (
                    f"Genesis Agentic: encountered an exception ({e}) at ({traceback.format_exc()})"
                    ", and can't respond."
                )
            )
    ...
    async def astream_chat(self, prompt: str) -> AgentStreamingResponse:    # type: ignore
        ...
        try:
            ...
            raise ValueError(
                f"Genesis Agentic: encountered an exception ({e}) at ({traceback.format_exc()}), and can't respond."
            ) from e
